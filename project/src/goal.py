...
KeyWord = {"ไปที่":"go_to",
            "ไปที่ห้องนอนหนึ่ง":"go_to_bedroom_one",
            "ไปที่ห้องนอนสอง":"go_to_bedroom_two",
            "ไปที่ห้องครัว ":"go_to_kitchen",
            "ไปที่ห้องน้ำ":"go_to_restroom",         
            }



Goal = {"go_to_bedroom_one":[-2,-2.5,-0.6601,0.7511],
        "go_to_bedroom_two":[-2,-3.5,-0.6601,0.7511],
        "go_to_kitchen":[0.5,-2.2,-0.6601,0.7511],
        "go_to_restroom":[-1.5,-2.2,-0.6601,0.7511],
        
        "Standby_Station":[2.5,-2.3,-0.6601,0.7511]}
